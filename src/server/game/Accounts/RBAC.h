...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_ATHENA = 1010,
    RBAC_PERM_COMMAND_ATHENA_SELECT = 1011,
    RBAC_PERM_COMMAND_ATHENA_LINK = 1012,
    RBAC_PERM_COMMAND_ATHENA_UNLINK = 1013,
    RBAC_PERM_COMMAND_IDYIA = 1020,
    RBAC_PERM_COMMAND_JANUS = 1030,
    RBAC_PERM_COMMAND_JANUS_LINK = 1031,
    RBAC_PERM_COMMAND_JANUS_DELETE = 1032,
    RBAC_PERM_COMMAND_PROMETHEUS = 1040,
    RBAC_PERM_COMMAND_BARBERSHOP = 1041,
    RBAC_PERM_COMMAND_WARP = 1042,
    RBAC_PERM_COMMAND_FACE = 1043,
    RBAC_PERM_MAX
};

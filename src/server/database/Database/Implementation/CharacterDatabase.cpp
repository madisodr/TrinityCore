...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_ONLINE, "SELECT name, account, map, zone FROM characters WHERE online > 0 LIMIT ?", CONNECTION_SYNCH);
    PrepareStatement(CHAR_SEL_CHARACTER_ONLINE_BY_MAP, "SELECT name, account, map, zone FROM characters WHERE online > 0 AND map = ? LIMIT ?", CONNECTION_SYNCH);
    PrepareStatement(CHAR_SEL_CHARACTER_ONLINE_BY_ZONE, "SELECT name, account, map, zone FROM characters WHERE online > 0 AND zone = ? LIMIT ?", CONNECTION_SYNCH);
